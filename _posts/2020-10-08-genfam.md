...
- Here, I have described how to use GenFam as a command line interface (CLI). The online version of GenFam can be found
...
# you must have an active internet connection for GenFam analysis
...
In addition, you can customize different parameters for GenFam analysis (check <a href=''>parameters</a> and list of 
<a href='/assets/posts/genfam/genfam_species_id.md'>plant species</a> supported by GenFam). 


## <span style="color:#33a8ff">GenFam citation</span>
- Bedre R, Mandadi K. GenFam: A web application for gene family-based classification and functional enrichment analysis 
  of plant genomes. bioRxiv. 2018 Jan 1:272187.
...
-->
<span style="color:#9e9696"><i> Last updated: October 09, 2020</i> </span>
