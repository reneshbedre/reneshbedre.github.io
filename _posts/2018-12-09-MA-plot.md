...
## <span style="color:#33a8ff">What is MA plot?</span>
 ...
 - Visualize and identify  gene expression changes from two different conditions (eg. normal vs. 
   treated) in terms of log fold change (M) on Y-axis and log of the mean of expression counts of normal and treated 
   samples (A) on X-axis
...
>>> df = pd.read_csv("https://reneshbedre.github.io/assets/posts/ma/test_dataset.csv")
>>> df.head()
...
>>> visuz.gene_exp.ma(df=df, lfc='log2FC', ct_count='value1', 
    st_count='value2')
...
<p align="center">
<img src="/assets/posts/ma/ma1.png" width="600">
</p>
...
# change colormap
>>> visuz.gene_exp.ma(df=df, lfc='log2FC', ct_count='value1', 
    st_count='value2', color=("#00239CFF","#E10600FF"))
```

<p align="center">
<img src="/assets/posts/ma/ma2.png" width="600">
</p>
...
<p align="center">
<img src="/assets/posts/ma/ma3.png" width="600">
</p>
...
>>> visuz.gene_exp.ma(df=df, lfc='log2FC', ct_count='value1', 
    st_count='value2', color=("#00239CFF","#E10600FF"), 
    markerdot='*', valpha=0.5)
```

<p align="center">
<img src="/assets/posts/ma/ma4.png" width="600">
</p>
