...
# note: if the data is balanced (equal sample size for each group), Type 1, 2, and 3 sums of squares (typ parameter)
...
Note: If you have unbalanced (unequal sample size for each group) data, you can perform similar steps as described
for one-way ANOVA with balanced design (equal sample size for each group).
...
+----+-----+-----+-----------+-----------+--------+---------+-----------+-----------+-----------+----------+
|    | group1   | group2   |   mean(group1) |   mean(group2) |   diff |      se | tail      |         T |   p-tukey |   hedges |
|----+-----+-----+-----------+-----------+--------+---------+-----------+-----------+-----------+----------|
|  0 | A   | B   |      29.6 |      45   |  -15.4 | 4.79062 | two-sided | -3.21462  | 0.010718  | -1.83635 |
|  1 | A   | C   |      29.6 |      31.2 |   -1.6 | 4.79062 | two-sided | -0.333986 | 0.9       | -0.19079 |
|  2 | A   | D   |      29.6 |      60   |  -30.4 | 4.79062 | two-sided | -6.34574  | 0.001     | -3.625   |
|  3 | B   | C   |      45   |      31.2 |   13.8 | 4.79062 | two-sided |  2.88063  | 0.0274098 |  1.64556 |
|  4 | B   | D   |      45   |      60   |  -15   | 4.79062 | two-sided | -3.13112  | 0.0136793 | -1.78865 |
|  5 | C   | D   |      31.2 |      60   |  -28.8 | 4.79062 | two-sided | -6.01175  | 0.001     | -3.43421 |
+----+-----+-----+-----------+-----------+--------+---------+-----------+-----------+-----------+----------+

# note; for clarity, I changed the column names for for factors as group1 and group2 (default it will print as 
# A and B
```
...
design for multifactorial ANOVA.
...
<span style="color:#9e9696"><i> Last updated: July 07, 2020</i> </span>
