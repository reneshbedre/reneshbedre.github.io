...
<!-- [dataset]({{"/assets/posts/bioinfokit_data/test_dataset.csv" | absolute_url }})-->
[dataset]({{"/assets/posts/mhat/gwas_res_sim.csv" | absolute_url }})
...
>>> df = pd.read_csv("https://reneshbedre.github.io/assets/posts/mhat/gwas_res_sim.csv")
>>> df.head()
   SNP    pvalue  chr
0  rs0  0.773739    3
1  rs1  0.554637    6
