...
<h6 style="color:#33a8ff">What is pandas?</h6>
...
<h6 style="color:#33a8ff">How to install pandas?</h6>
...
<h6 style="color:#33a8ff">Create dataframe and series using pandas</h6>
...
<h6 style="color:#33a8ff">Import data from file</h6>
...
<h6 style="color:#33a8ff">Check data type (dtype)</h6> 
...
<h6 style="color:#33a8ff">Check dataframe dimensions (size, shape and ndim)</h6> 
...
<h6 style="color:#33a8ff">Extracting columns and rows from dataframe</h6> 
```python
...
<h6 style="color:#33a8ff">Extracting subsets of dataframes</h6> 
```python
...
<h6 style="color:#33a8ff">Statistics of dataframes</h6> 
...
<h6 style="color:#33a8ff">Add/Insert rows and columns to existing dataframes</h6>
```python
# check above to create dataframe objects (df1, df2 and df1_1)
...
<h6 style="color:#33a8ff">Export dataframes to file</h6>
...
<h6 style="color:#33a8ff">Convert series to dataframes</h6>
```python
...
<h6 style="color:#33a8ff">Convert numpy arrays to dataframes</h6>
```python
>>> import numpy as np
>>> x = np.array([[ 1,  2], [ 3 ,4]])
