...
## <span style="color:#33a8ff">One Sample \(\it{t}\)-test </span>
- One Sample \(\it{t}\)-test is used to compare the sample mean (a random sample from a population) with the specific 
...
### <span style="color:#33a8ff">How to perform one sample \(\it{t}\)-test in Python?</span>
...
### Interpretation
The <i>p</i> value obtained from the one sample \(\it{t}\)-test is not significant (<i>p</i> > 0.05), and therefore, we conclude 
that the average diameter of the balls in a random sample is equal to  5 cm.

## <span style="color:#33a8ff">Two sample \(\it{t}\)-test (unpaired or independent \(\it{t}\)-test)</span>
 - Two Sample independent \(\it{t}\)-test Used to compare the means of two independent groups 
...
### Two sample \(\it{t}\)-test Hypotheses
...
### Two sample \(\it{t}\)-test Assumptions
...
### How to perform Two sample \(\it{t}\)-test in Python?
- We will use `bioinfokit v0.9.6` or later
- Check [bioinfokit documentation]({{"/blog/howtoinstall.html" | absolute_url }}) for installation and documentation
- Download <a href="/assets/posts/ttest/genotype.csv">dataset</a> for two sample and Welch's \(\it{t}\)-test
...
```
<b>Note</b>: Even though you can perform a \(\it{t}\)-test when the sample size is unequal between two groups, it is more 
efficient to have an equal sample size in two groups to increase the power of the \(\it{t}\)-test.
...
### Interpretation
The <i>p</i> value obtained from the \(\it{t}\)-test is significant (<i>p</i> < 0.05), and therefore, we conclude that the 
yield of genotype A is significantly different than genotype B.


## <span style="color:#33a8ff">Paired \(\it{t}\)-test (dependent \(\it{t}\)-test)</span>
- Paired \(\it{t}\)-test used to compare the differences between the pair of dependent variables for the same 
  subject 
...
- <b>Note</b>: Paired \(\it{t}\)-test is a one sample \(\it{t}\)-test on the differences between the two dependent variables

### Paired \(\it{t}\)-test Hypotheses
...
<span style="color:#9e9696"><i> Last updated: November 13, 2020</i> </span>
