...
The interaction plot help to visualize the means of the response of the two groups. The X-axis should have group with 
more levels. As the three lines are not parallel, there is significant interaction in the groups (roughly parallel group
lines indicates no interaction). For more reliable conclusion of interaction plot, it should be verified with <i>F</i>
