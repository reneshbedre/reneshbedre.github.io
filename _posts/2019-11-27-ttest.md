...
### Interpretation
The <i>p</i> value obtained from the one sample t-test is not significant (<i>p</i> > 0.05), and therefore, we conclude 
...
### Interpretation
The <i>p</i> value obtained from the t-test is significant (<i>p</i> < 0.05), and therefore, we conclude that the 
