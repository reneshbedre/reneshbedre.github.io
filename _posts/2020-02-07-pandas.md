...
## <span style="color:#33a8ff">Modifying dataframe columns</span>
```python
>>> import pandas as pd
>>> df = pd.read_csv("https://reneshbedre.github.io/assets/posts/anova/onewayanova.txt", sep="\t")
>>> df.head()
...
Bedre, R. (2020, February 07). Data handling and manipulation with Pandas. 
https://reneshbedre.github.io/blog/pandas.html

<span style="color:#9e9696">If you have any questions, comments or recommendations, please email me at 
<b>reneshbe@gmail.com</b></span>
    
<span style="color:#9e9696"><i> Last updated: June 23, 2020</i> </span>
