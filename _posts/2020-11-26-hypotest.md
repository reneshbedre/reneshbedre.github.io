...
## <span style="color:#33a8ff">Type I (&alpha;) and II errors (&beta;)</span>
...
- If the <i>p</> value obtained from <i>t</>-test is less than the significance level (&alpha;), the null hypothesis
  is rejected. The significance level (&alpha;) is also know as type I error (false positive).
